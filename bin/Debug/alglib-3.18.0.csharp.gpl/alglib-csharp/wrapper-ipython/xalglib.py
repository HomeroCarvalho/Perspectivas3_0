...
if curdir=="":
    curdir = "."
_net_candidates = []
_net_candidates.append(os.path.join(os.path.relpath(curdir),"alglib318gpl_net2.dll"))
_net_candidates.append(os.path.join(sys.prefix,"alglib318gpl_net2.dll"))
_net_candidates.append(os.path.join(os.sep+"usr","local","alglib318gpl_net2.dll"))
...
def hqrndnormalv(*functionargs):
    ...
    try:
        ...
        # call function
        _net_x = _net_alglib.hqrndnormalv(_net_state, _net_n)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def hqrndnormalm(*functionargs):
    # unpack inputs
    state, m, n = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_x = _net_alglib.hqrndnormalm(_net_state, _net_m, _net_n)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def rvectorcopy(*functionargs):
    # unpack inputs
    n, a, ia, b, ib = functionargs
    friendly_form = False

    # convert to .NET types
    _net_n = n
    _net_a = net_from_list(a, DT_REAL, "ALGLIB: parameter 'a' of 'xalglib.rvectorcopy' must be real vector")
    _net_ia = ia
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.rvectorcopy' must be real vector")
    _net_ib = ib
    try:

        # call function
        _net_b = _net_alglib.rvectorcopy(_net_n, _net_a, _net_ia, _net_b, _net_ib)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def rmatrixgencopy(*functionargs):
    # unpack inputs
    m, n, alpha, a, ia, ja, beta, b, ib, jb = functionargs
    friendly_form = False
    ...
    _net_n = n
    _net_alpha = alpha
    _net_a = net_from_listlist(a, DT_REAL, "ALGLIB: parameter 'a' of 'xalglib.rmatrixgencopy' must be real matrix")
    _net_ia = ia
    _net_ja = ja
    _net_beta = beta
    _net_b = net_from_listlist(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.rmatrixgencopy' must be real matrix")
    _net_ib = ib
    _net_jb = jb
    try:

        # call function
        _net_b = _net_alglib.rmatrixgencopy(_net_m, _net_n, _net_alpha, _net_a, _net_ia, _net_ja, _net_beta, _net_b, _net_ib, _net_jb)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
class sparsebuffers(object):
    def __init__(self,ptr):
        self.ptr = ptr
def sparseserialize(obj):
    try:
        return _net_alglib.sparseserialize(obj.ptr)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

def sparseunserialize(s_in):
    try:
        return sparsematrix(_net_alglib.sparseunserialize(s_in))
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparseexists(*functionargs):
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.sparseexists(_net_s, _net_i, _net_j)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsegemv(*functionargs):
    # unpack inputs
    s, alpha, ops, x, ix, beta, y, iy = functionargs
    friendly_form = False
    ...
    _net_alpha = alpha
    _net_ops = ops
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.sparsegemv' must be real vector")
    _net_ix = ix
    _net_beta = beta
    _net_y = net_from_list(y, DT_REAL, "ALGLIB: parameter 'y' of 'xalglib.sparsegemv' must be real vector")
    _net_iy = iy
    try:

        # call function
        _net_y = _net_alglib.sparsegemv(_net_s, _net_alpha, _net_ops, _net_x, _net_ix, _net_beta, _net_y, _net_iy)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesymmpermtbl(*functionargs):
    # unpack inputs
    a, isupper, p = functionargs
    friendly_form = False

    # convert to .NET types
    _net_a = a.ptr
    _net_isupper = isupper
    _net_p = net_from_list(p, DT_INT, "ALGLIB: parameter 'p' of 'xalglib.sparsesymmpermtbl' must be int vector")
    try:

        # call function
        _net_b = _net_alglib.sparsesymmpermtbl(_net_a, _net_isupper, _net_p)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    b = sparsematrix(_net_b)

    # return
    return b

def sparsesymmpermtblbuf(*functionargs):
    # unpack inputs
    a, isupper, p, b = functionargs
    friendly_form = False

    # convert to .NET types
    _net_a = a.ptr
    _net_isupper = isupper
    _net_p = net_from_list(p, DT_INT, "ALGLIB: parameter 'p' of 'xalglib.sparsesymmpermtblbuf' must be int vector")
    _net_b = b.ptr
    try:

        # call function
        _net_alglib.sparsesymmpermtblbuf(_net_a, _net_isupper, _net_p, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsetransposecrs(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.sparsetransposecrs(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsecopytransposecrs(*functionargs):
    # unpack inputs
    s0,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_s1 = _net_alglib.sparsecopytransposecrs(_net_s0)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsecopytransposecrsbuf(*functionargs):
    # unpack inputs
    s0, s1 = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.sparsecopytransposecrsbuf(_net_s0, _net_s1)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
class sparsedecompositionanalysis(object):
    def __init__(self,ptr):
        self.ptr = ptr
...
def sparselu(*functionargs):
    # unpack inputs
    a, pivottype = functionargs
    friendly_form = False

    # convert to .NET types
    _net_a = a.ptr
    _net_pivottype = pivottype
    try:

        # call function
        _net_result, _net_p, _net_q = _net_alglib.sparselu(_net_a, _net_pivottype)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    result = _net_result
    p = list_from_net(_net_p, DT_INT)
    q = list_from_net(_net_q, DT_INT)
...
def sparsecholesky(*functionargs):
    # unpack inputs
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.sparsecholesky(_net_a, _net_isupper)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsecholeskyp(*functionargs):
    # unpack inputs
    a, isupper = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_result, _net_p = _net_alglib.sparsecholeskyp(_net_a, _net_isupper)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsecholeskyanalyze(*functionargs):
    # unpack inputs
    a, isupper, facttype, permtype = functionargs
    friendly_form = False

    # convert to .NET types
    _net_a = a.ptr
    _net_isupper = isupper
    _net_facttype = facttype
    _net_permtype = permtype
    try:

        # call function
        _net_result, _net_analysis = _net_alglib.sparsecholeskyanalyze(_net_a, _net_isupper, _net_facttype, _net_permtype)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    result = _net_result
    analysis = sparsedecompositionanalysis(_net_analysis)

    # return
    return (result, analysis)

def sparsecholeskyfactorize(*functionargs):
    # unpack inputs
    analysis, needupper = functionargs
    friendly_form = False

    # convert to .NET types
    _net_analysis = analysis.ptr
    _net_needupper = needupper
    try:

        # call function
        _net_result, _net_a, _net_d, _net_p = _net_alglib.sparsecholeskyfactorize(_net_analysis, _net_needupper)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    result = _net_result
    a = sparsematrix(_net_a)
    d = list_from_net(_net_d, DT_REAL)
    p = list_from_net(_net_p, DT_INT)
...
def sparsecholeskyreload(*functionargs):
    # unpack inputs
    analysis, a, isupper = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.sparsecholeskyreload(_net_analysis, _net_a, _net_isupper)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsespdsolvesks(*functionargs):
    # unpack inputs
    a, isupper, b = functionargs
    friendly_form = False

    # convert to .NET types
    _net_a = a.ptr
    _net_isupper = isupper
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.sparsespdsolvesks' must be real vector")
    try:

        # call function
        _net_x, _net_rep = _net_alglib.sparsespdsolvesks(_net_a, _net_isupper, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsespdsolve(*functionargs):
    # unpack inputs
    a, isupper, b = functionargs
    friendly_form = False
    ...
    _net_a = a.ptr
    _net_isupper = isupper
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.sparsespdsolve' must be real vector")
    try:

        # call function
        _net_x, _net_rep = _net_alglib.sparsespdsolve(_net_a, _net_isupper, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsespdcholeskysolve(*functionargs):
    # unpack inputs
    a, isupper, b = functionargs
    friendly_form = False
    ...
    _net_a = a.ptr
    _net_isupper = isupper
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.sparsespdcholeskysolve' must be real vector")
    try:

        # call function
        _net_x, _net_rep = _net_alglib.sparsespdcholeskysolve(_net_a, _net_isupper, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolve(*functionargs):
    ...
    # convert to .NET types
    _net_a = a.ptr
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.sparsesolve' must be real vector")
    try:

        # call function
        _net_x, _net_rep = _net_alglib.sparsesolve(_net_a, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparselusolve(*functionargs):
    # unpack inputs
    a, p, q, b = functionargs
    friendly_form = False

    # convert to .NET types
    _net_a = a.ptr
    _net_p = net_from_list(p, DT_INT, "ALGLIB: parameter 'p' of 'xalglib.sparselusolve' must be int vector")
    _net_q = net_from_list(q, DT_INT, "ALGLIB: parameter 'q' of 'xalglib.sparselusolve' must be int vector")
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.sparselusolve' must be real vector")
    try:

        # call function
        _net_x, _net_rep = _net_alglib.sparselusolve(_net_a, _net_p, _net_q, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
class sparsesolverstate(object):
    def __init__(self,ptr):
        self.ptr = ptr
def sparsesolvesymmetricgmres(*functionargs):
    # unpack inputs
    a, isupper, b, k, epsf, maxits = functionargs
    friendly_form = False

    # convert to .NET types
    _net_a = a.ptr
    _net_isupper = isupper
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.sparsesolvesymmetricgmres' must be real vector")
    _net_k = k
    _net_epsf = epsf
    _net_maxits = maxits
    try:
        ...
        # call function
        _net_x, _net_rep = _net_alglib.sparsesolvesymmetricgmres(_net_a, _net_isupper, _net_b, _net_k, _net_epsf, _net_maxits)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolvegmres(*functionargs):
    # unpack inputs
    a, b, k, epsf, maxits = functionargs
    friendly_form = False

    # convert to .NET types
    _net_a = a.ptr
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.sparsesolvegmres' must be real vector")
    _net_k = k
    _net_epsf = epsf
    _net_maxits = maxits
    try:
        ...
        # call function
        _net_x, _net_rep = _net_alglib.sparsesolvegmres(_net_a, _net_b, _net_k, _net_epsf, _net_maxits)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolvercreate(*functionargs):
    # unpack inputs
    n,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_state = _net_alglib.sparsesolvercreate(_net_n)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    state = sparsesolverstate(_net_state)

    # return
    return state

def sparsesolversetalgogmres(*functionargs):
    # unpack inputs
    state, k = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.sparsesolversetalgogmres(_net_state, _net_k)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolversetstartingpoint(*functionargs):
    # unpack inputs
    state, x = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.sparsesolversetstartingpoint' must be real vector")
    try:

        # call function
        _net_alglib.sparsesolversetstartingpoint(_net_state, _net_x)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolversetcond(*functionargs):
    # unpack inputs
    ...
    try:
        ...
        # call function
        _net_alglib.sparsesolversetcond(_net_state, _net_epsf, _net_maxits)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolversolvesymmetric(*functionargs):
    # unpack inputs
    ...
    _net_a = a.ptr
    _net_isupper = isupper
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.sparsesolversolvesymmetric' must be real vector")
    try:

        # call function
        _net_alglib.sparsesolversolvesymmetric(_net_state, _net_a, _net_isupper, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolversolve(*functionargs):
    # unpack inputs
    ...
    _net_state = state.ptr
    _net_a = a.ptr
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.sparsesolversolve' must be real vector")
    try:

        # call function
        _net_alglib.sparsesolversolve(_net_state, _net_a, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolverresults(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_x, _net_rep = _net_alglib.sparsesolverresults(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolversetxrep(*functionargs):
    # unpack inputs
    ...
    try:
        ...
        # call function
        _net_alglib.sparsesolversetxrep(_net_state, _net_needxrep)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolveroocstart(*functionargs):
    # unpack inputs
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_b = net_from_list(b, DT_REAL, "ALGLIB: parameter 'b' of 'xalglib.sparsesolveroocstart' must be real vector")
    try:

        # call function
        _net_alglib.sparsesolveroocstart(_net_state, _net_b)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolverooccontinue(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.sparsesolverooccontinue(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolveroocgetrequestinfo(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_requesttype = _net_alglib.sparsesolveroocgetrequestinfo(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolveroocgetrequestdata(*functionargs):
    # unpack inputs
    state, x = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.sparsesolveroocgetrequestdata' must be real vector")
    try:

        # call function
        _net_x = _net_alglib.sparsesolveroocgetrequestdata(_net_state, _net_x)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolveroocgetrequestdata1(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_v = _net_alglib.sparsesolveroocgetrequestdata1(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolveroocsendresult(*functionargs):
    # unpack inputs
    state, ax = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_ax = net_from_list(ax, DT_REAL, "ALGLIB: parameter 'ax' of 'xalglib.sparsesolveroocsendresult' must be real vector")
    try:

        # call function
        _net_alglib.sparsesolveroocsendresult(_net_state, _net_ax)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolveroocstop(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_x, _net_rep = _net_alglib.sparsesolveroocstop(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def sparsesolverrequesttermination(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.sparsesolverrequesttermination(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def linlsqrcreatebuf(*functionargs):
    # unpack inputs
    m, n, state = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.linlsqrcreatebuf(_net_m, _net_n, _net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def linlsqrpeekiterationscount(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.linlsqrpeekiterationscount(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def linlsqrrequesttermination(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.linlsqrrequesttermination(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def net_from_optguardreport(x,v):
    x.nonc0suspected = bool(v.nonc0suspected)
    x.nonc0suspected = int(v.nonc0suspected)
    x.nonc0test0positive = bool(v.nonc0test0positive)
    x.nonc0test0positive = int(v.nonc0test0positive)
    x.nonc0fidx = int(v.nonc0fidx)
    x.nonc0lipschitzc = float(v.nonc0lipschitzc)
    x.nonc1suspected = bool(v.nonc1suspected)
    x.nonc1suspected = int(v.nonc1suspected)
    x.nonc1test0positive = bool(v.nonc1test0positive)
    x.nonc1test0positive = int(v.nonc1test0positive)
    x.nonc1test1positive = bool(v.nonc1test1positive)
    x.nonc1test1positive = int(v.nonc1test1positive)
    x.nonc1fidx = int(v.nonc1fidx)
    x.nonc1lipschitzc = float(v.nonc1lipschitzc)
    x.badgradsuspected = bool(v.badgradsuspected)
    x.badgradsuspected = int(v.badgradsuspected)
    x.badgradfidx = int(v.badgradfidx)
    x.badgradvidx = int(v.badgradvidx)
    x.badgradxbase = net_from_list(v.badgradxbase, DT_REAL)
    x.badgraduser = net_from_listlist(v.badgraduser, DT_REAL)
    x.badgradnum = net_from_listlist(v.badgradnum, DT_REAL)
    return




def optguardreport_from_net(x):
    r = optguardreport()
    r.nonc0suspected = x.nonc0suspected
    r.nonc0test0positive = x.nonc0test0positive
    r.nonc0fidx = x.nonc0fidx
    ...
    r.nonc1fidx = x.nonc1fidx
    r.nonc1lipschitzc = x.nonc1lipschitzc
    r.badgradsuspected = x.badgradsuspected
    r.badgradfidx = x.badgradfidx
    r.badgradvidx = x.badgradvidx
    r.badgradxbase = list_from_net(x.badgradxbase, DT_REAL)
    r.badgraduser = listlist_from_net(x.badgraduser, DT_REAL)
    r.badgradnum = listlist_from_net(x.badgradnum, DT_REAL)
    return r
...
def net_from_optguardnonc0report(x,v):
    x.positive = bool(v.positive)
    x.positive = int(v.positive)
    x.fidx = int(v.fidx)
    x.x0 = net_from_list(v.x0, DT_REAL)
    x.d = net_from_list(v.d, DT_REAL)
    x.n = int(v.n)
    x.stp = net_from_list(v.stp, DT_REAL)
    x.f = net_from_list(v.f, DT_REAL)
    x.cnt = int(v.cnt)
    x.stpidxa = int(v.stpidxa)
    x.stpidxb = int(v.stpidxb)
    return




def optguardnonc0report_from_net(x):
    r = optguardnonc0report()
    r.positive = x.positive
    r.fidx = x.fidx
    r.x0 = list_from_net(x.x0, DT_REAL)
    r.d = list_from_net(x.d, DT_REAL)
    r.n = x.n
    r.stp = list_from_net(x.stp, DT_REAL)
    r.f = list_from_net(x.f, DT_REAL)
    r.cnt = x.cnt
    r.stpidxa = x.stpidxa
    r.stpidxb = x.stpidxb
    return r
...
def net_from_optguardnonc1test0report(x,v):
    x.positive = bool(v.positive)
    x.positive = int(v.positive)
    x.fidx = int(v.fidx)
    x.x0 = net_from_list(v.x0, DT_REAL)
...
def optguardnonc1test0report_from_net(x):
...
def net_from_optguardnonc1test1report(x,v):
    x.positive = bool(v.positive)
    x.positive = int(v.positive)
    x.fidx = int(v.fidx)
    x.vidx = int(v.vidx)
...
def optguardnonc1test1report_from_net(x):
...
def minlbfgsoptguardgradient(*functionargs):
    # unpack inputs
    ...
    try:
        ...
        # call function
        _net_alglib.minlbfgsoptguardgradient(_net_state, _net_teststep)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlbfgsoptguardsmoothness(*functionargs):
    ...
    if len(functionargs)==2:
        ...
        # short-form call
        state,  = functionargs
        level = check_equality_and_get([1],"Error while calling 'minlbfgsoptguardsmoothness': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'minlbfgsoptguardsmoothness': function must have 2 or 1 parameters")
    ...
    try:
        ...
        # call function
        _net_alglib.minlbfgsoptguardsmoothness(_net_state, _net_level)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlbfgsoptguardresults(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_rep = _net_alglib.minlbfgsoptguardresults(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    rep = optguardreport_from_net(_net_rep)

    # return
    return rep

def minlbfgsoptguardnonc1test0results(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_strrep, _net_lngrep = _net_alglib.minlbfgsoptguardnonc1test0results(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    strrep = optguardnonc1test0report_from_net(_net_strrep)
    lngrep = optguardnonc1test0report_from_net(_net_lngrep)

    # return
    return (strrep, lngrep)

def minlbfgsoptguardnonc1test1results(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_strrep, _net_lngrep = _net_alglib.minlbfgsoptguardnonc1test1results(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    strrep = optguardnonc1test1report_from_net(_net_strrep)
    lngrep = optguardnonc1test1report_from_net(_net_lngrep)
...
def minbleicoptguardgradient(*functionargs):
    # unpack inputs
    state, teststep = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minbleicoptguardgradient(_net_state, _net_teststep)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minbleicoptguardsmoothness(*functionargs):
    ...
    if len(functionargs)==2:
        ...
        # short-form call
        state,  = functionargs
        level = check_equality_and_get([1],"Error while calling 'minbleicoptguardsmoothness': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'minbleicoptguardsmoothness': function must have 2 or 1 parameters")
    ...
    try:
        ...
        # call function
        _net_alglib.minbleicoptguardsmoothness(_net_state, _net_level)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minbleicoptguardresults(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_rep = _net_alglib.minbleicoptguardresults(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minbleicoptguardnonc1test0results(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_strrep, _net_lngrep = _net_alglib.minbleicoptguardnonc1test0results(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minbleicoptguardnonc1test1results(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_strrep, _net_lngrep = _net_alglib.minbleicoptguardnonc1test1results(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def net_from_minqpreport(x,v):
    ...
    x.terminationtype = int(v.terminationtype)
    x.lagbc = net_from_list(v.lagbc, DT_REAL)
    x.laglc = net_from_list(v.laglc, DT_REAL)
    return
...
def minqpreport_from_net(x):
    ...
    r.terminationtype = x.terminationtype
    r.lagbc = list_from_net(x.lagbc, DT_REAL)
    r.laglc = list_from_net(x.laglc, DT_REAL)
    return r
...
def minqpsetalgodenseipm(*functionargs):
    # unpack inputs
    state, eps = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minqpsetalgodenseipm(_net_state, _net_eps)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpsetalgosparseipm(*functionargs):
    # unpack inputs
    state, eps = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minqpsetalgosparseipm(_net_state, _net_eps)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpsetbcall(*functionargs):
    # unpack inputs
    state, bndl, bndu = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minqpsetbcall(_net_state, _net_bndl, _net_bndu)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpsetbci(*functionargs):
    # unpack inputs
    state, i, bndl, bndu = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minqpsetbci(_net_state, _net_i, _net_bndl, _net_bndu)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpsetlcmixed(*functionargs):
    # unpack inputs
    state, sparsec, sparsect, sparsek, densec, densect, densek = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minqpsetlcmixed(_net_state, _net_sparsec, _net_sparsect, _net_sparsek, _net_densec, _net_densect, _net_densek)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpsetlcmixedlegacy(*functionargs):
    # unpack inputs
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_densec = net_from_listlist(densec, DT_REAL, "ALGLIB: parameter 'densec' of 'xalglib.minqpsetlcmixedlegacy' must be real matrix")
    _net_densect = net_from_list(densect, DT_INT, "ALGLIB: parameter 'densect' of 'xalglib.minqpsetlcmixedlegacy' must be int vector")
    _net_densek = densek
    _net_sparsec = sparsec.ptr
    _net_sparsect = net_from_list(sparsect, DT_INT, "ALGLIB: parameter 'sparsect' of 'xalglib.minqpsetlcmixedlegacy' must be int vector")
    _net_sparsek = sparsek
    try:

        # call function
        _net_alglib.minqpsetlcmixedlegacy(_net_state, _net_densec, _net_densect, _net_densek, _net_sparsec, _net_sparsect, _net_sparsek)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpsetlc2dense(*functionargs):
    ...
    if len(functionargs)==5:
        ...
        k = check_equality_and_get([safe_rows("'minqpsetlc2dense': incorrect parameters",a), safe_len("'minqpsetlc2dense': incorrect parameters",al), safe_len("'minqpsetlc2dense': incorrect parameters",au)],"Error while calling 'minqpsetlc2dense': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'minqpsetlc2dense': function must have 5 or 4 parameters")

    # convert to .NET types
    _net_state = state.ptr
    _net_a = net_from_listlist(a, DT_REAL, "ALGLIB: parameter 'a' of 'xalglib.minqpsetlc2dense' must be real matrix")
    _net_al = net_from_list(al, DT_REAL, "ALGLIB: parameter 'al' of 'xalglib.minqpsetlc2dense' must be real vector")
    _net_au = net_from_list(au, DT_REAL, "ALGLIB: parameter 'au' of 'xalglib.minqpsetlc2dense' must be real vector")
    _net_k = k
    try:

        # call function
        _net_alglib.minqpsetlc2dense(_net_state, _net_a, _net_al, _net_au, _net_k)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpsetlc2(*functionargs):
    ...
    _net_state = state.ptr
    _net_a = a.ptr
    _net_al = net_from_list(al, DT_REAL, "ALGLIB: parameter 'al' of 'xalglib.minqpsetlc2' must be real vector")
    _net_au = net_from_list(au, DT_REAL, "ALGLIB: parameter 'au' of 'xalglib.minqpsetlc2' must be real vector")
    _net_k = k
    try:

        # call function
        _net_alglib.minqpsetlc2(_net_state, _net_a, _net_al, _net_au, _net_k)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpsetlc2mixed(*functionargs):
    # unpack inputs
    state, sparsea, ksparse, densea, kdense, al, au = functionargs
    friendly_form = False

    # convert to .NET types
    _net_state = state.ptr
    _net_sparsea = sparsea.ptr
    _net_ksparse = ksparse
    _net_densea = net_from_listlist(densea, DT_REAL, "ALGLIB: parameter 'densea' of 'xalglib.minqpsetlc2mixed' must be real matrix")
    _net_kdense = kdense
    _net_al = net_from_list(al, DT_REAL, "ALGLIB: parameter 'al' of 'xalglib.minqpsetlc2mixed' must be real vector")
    _net_au = net_from_list(au, DT_REAL, "ALGLIB: parameter 'au' of 'xalglib.minqpsetlc2mixed' must be real vector")
    try:

        # call function
        _net_alglib.minqpsetlc2mixed(_net_state, _net_sparsea, _net_ksparse, _net_densea, _net_kdense, _net_al, _net_au)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpaddlc2dense(*functionargs):
    # unpack inputs
    state, a, al, au = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_a = net_from_list(a, DT_REAL, "ALGLIB: parameter 'a' of 'xalglib.minqpaddlc2dense' must be real vector")
    _net_al = al
    _net_au = au
    try:

        # call function
        _net_alglib.minqpaddlc2dense(_net_state, _net_a, _net_al, _net_au)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpaddlc2(*functionargs):
    # unpack inputs
    state, idxa, vala, nnz, al, au = functionargs
    friendly_form = False

    # convert to .NET types
    _net_state = state.ptr
    _net_idxa = net_from_list(idxa, DT_INT, "ALGLIB: parameter 'idxa' of 'xalglib.minqpaddlc2' must be int vector")
    _net_vala = net_from_list(vala, DT_REAL, "ALGLIB: parameter 'vala' of 'xalglib.minqpaddlc2' must be real vector")
    _net_nnz = nnz
    _net_al = al
    _net_au = au
    try:
        ...
        # call function
        _net_alglib.minqpaddlc2(_net_state, _net_idxa, _net_vala, _net_nnz, _net_al, _net_au)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minqpaddlc2sparsefromdense(*functionargs):
    # unpack inputs
    state, da, al, au = functionargs
    friendly_form = False

    # convert to .NET types
    _net_state = state.ptr
    _net_da = net_from_list(da, DT_REAL, "ALGLIB: parameter 'da' of 'xalglib.minqpaddlc2sparsefromdense' must be real vector")
    _net_al = al
    _net_au = au
    try:

        # call function
        _net_alglib.minqpaddlc2sparsefromdense(_net_state, _net_da, _net_al, _net_au)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlmoptguardgradient(*functionargs):
    # unpack inputs
    state, teststep = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minlmoptguardgradient(_net_state, _net_teststep)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlmoptguardresults(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_rep = _net_alglib.minlmoptguardresults(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def mincgoptguardgradient(*functionargs):
    # unpack inputs
    state, teststep = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.mincgoptguardgradient(_net_state, _net_teststep)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def mincgoptguardsmoothness(*functionargs):
    ...
    if len(functionargs)==2:
        ...
        # short-form call
        state,  = functionargs
        level = check_equality_and_get([1],"Error while calling 'mincgoptguardsmoothness': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'mincgoptguardsmoothness': function must have 2 or 1 parameters")
    ...
    try:
        ...
        # call function
        _net_alglib.mincgoptguardsmoothness(_net_state, _net_level)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def mincgoptguardresults(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_rep = _net_alglib.mincgoptguardresults(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def mincgoptguardnonc1test0results(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_strrep, _net_lngrep = _net_alglib.mincgoptguardnonc1test0results(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def mincgoptguardnonc1test1results(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_strrep, _net_lngrep = _net_alglib.mincgoptguardnonc1test1results(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def net_from_minlpreport(x,v):
    x.f = float(v.f)
    x.lagbc = net_from_list(v.lagbc, DT_REAL)
    x.laglc = net_from_list(v.laglc, DT_REAL)
    x.y = net_from_list(v.y, DT_REAL)
    x.stats = net_from_list(v.stats, DT_INT)
    x.primalerror = float(v.primalerror)
    x.dualerror = float(v.dualerror)
    x.slackerror = float(v.slackerror)
    x.iterationscount = int(v.iterationscount)
    x.terminationtype = int(v.terminationtype)
    return
...
def minlpreport_from_net(x):
    r = minlpreport()
    r.f = x.f
    r.lagbc = list_from_net(x.lagbc, DT_REAL)
    r.laglc = list_from_net(x.laglc, DT_REAL)
    r.y = list_from_net(x.y, DT_REAL)
    r.stats = list_from_net(x.stats, DT_INT)
    r.primalerror = x.primalerror
    r.dualerror = x.dualerror
    r.slackerror = x.slackerror
    r.iterationscount = x.iterationscount
    r.terminationtype = x.terminationtype
    return r


def minlpcreate(*functionargs):
    # unpack inputs
    n,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_state = _net_alglib.minlpcreate(_net_n)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    state = minlpstate(_net_state)

    # return
    return state

def minlpsetalgodss(*functionargs):
    # unpack inputs
    state, eps = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minlpsetalgodss(_net_state, _net_eps)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpsetalgoipm(*functionargs):
    # unpack inputs
    if len(functionargs)==2:
        # full-form call
        state, eps = functionargs
        ...
        # short-form call
        state,  = functionargs
        eps = check_equality_and_get([0],"Error while calling 'minlpsetalgoipm': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'minlpsetalgoipm': function must have 2 or 1 parameters")
    ...
    try:
        ...
        # call function
        _net_alglib.minlpsetalgoipm(_net_state, _net_eps)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpsetcost(*functionargs):
    # unpack inputs
    state, c = functionargs
    friendly_form = False

    # convert to .NET types
    _net_state = state.ptr
    _net_c = net_from_list(c, DT_REAL, "ALGLIB: parameter 'c' of 'xalglib.minlpsetcost' must be real vector")
    try:

        # call function
        _net_alglib.minlpsetcost(_net_state, _net_c)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpsetscale(*functionargs):
    # unpack inputs
    state, s = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_s = net_from_list(s, DT_REAL, "ALGLIB: parameter 's' of 'xalglib.minlpsetscale' must be real vector")
    try:

        # call function
        _net_alglib.minlpsetscale(_net_state, _net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpsetbc(*functionargs):
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_bndl = net_from_list(bndl, DT_REAL, "ALGLIB: parameter 'bndl' of 'xalglib.minlpsetbc' must be real vector")
    _net_bndu = net_from_list(bndu, DT_REAL, "ALGLIB: parameter 'bndu' of 'xalglib.minlpsetbc' must be real vector")
    try:

        # call function
        _net_alglib.minlpsetbc(_net_state, _net_bndl, _net_bndu)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpsetbcall(*functionargs):
    # unpack inputs
    state, bndl, bndu = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minlpsetbcall(_net_state, _net_bndl, _net_bndu)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpsetbci(*functionargs):
    ...
    try:
        ...
        # call function
        _net_alglib.minlpsetbci(_net_state, _net_i, _net_bndl, _net_bndu)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpsetlc(*functionargs):
    ...
    if len(functionargs)==4:
        ...
        k = check_equality_and_get([safe_rows("'minlpsetlc': incorrect parameters",a), safe_len("'minlpsetlc': incorrect parameters",ct)],"Error while calling 'minlpsetlc': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'minlpsetlc': function must have 4 or 3 parameters")

    # convert to .NET types
    _net_state = state.ptr
    _net_a = net_from_listlist(a, DT_REAL, "ALGLIB: parameter 'a' of 'xalglib.minlpsetlc' must be real matrix")
    _net_ct = net_from_list(ct, DT_INT, "ALGLIB: parameter 'ct' of 'xalglib.minlpsetlc' must be int vector")
    _net_k = k
    try:

        # call function
        _net_alglib.minlpsetlc(_net_state, _net_a, _net_ct, _net_k)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpsetlc2dense(*functionargs):
    ...
    if len(functionargs)==5:
        ...
        # short-form call
        state, a, al, au = functionargs
        k = check_equality_and_get([safe_rows("'minlpsetlc2dense': incorrect parameters",a), safe_len("'minlpsetlc2dense': incorrect parameters",al), safe_len("'minlpsetlc2dense': incorrect parameters",au)],"Error while calling 'minlpsetlc2dense': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'minlpsetlc2dense': function must have 5 or 4 parameters")

    # convert to .NET types
    _net_state = state.ptr
    _net_a = net_from_listlist(a, DT_REAL, "ALGLIB: parameter 'a' of 'xalglib.minlpsetlc2dense' must be real matrix")
    _net_al = net_from_list(al, DT_REAL, "ALGLIB: parameter 'al' of 'xalglib.minlpsetlc2dense' must be real vector")
    _net_au = net_from_list(au, DT_REAL, "ALGLIB: parameter 'au' of 'xalglib.minlpsetlc2dense' must be real vector")
    _net_k = k
    try:

        # call function
        _net_alglib.minlpsetlc2dense(_net_state, _net_a, _net_al, _net_au, _net_k)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpsetlc2(*functionargs):
    ...
    _net_state = state.ptr
    _net_a = a.ptr
    _net_al = net_from_list(al, DT_REAL, "ALGLIB: parameter 'al' of 'xalglib.minlpsetlc2' must be real vector")
    _net_au = net_from_list(au, DT_REAL, "ALGLIB: parameter 'au' of 'xalglib.minlpsetlc2' must be real vector")
    _net_k = k
    try:

        # call function
        _net_alglib.minlpsetlc2(_net_state, _net_a, _net_al, _net_au, _net_k)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpaddlc2dense(*functionargs):
    # unpack inputs
    state, a, al, au = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_a = net_from_list(a, DT_REAL, "ALGLIB: parameter 'a' of 'xalglib.minlpaddlc2dense' must be real vector")
    _net_al = al
    _net_au = au
    try:

        # call function
        _net_alglib.minlpaddlc2dense(_net_state, _net_a, _net_al, _net_au)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpaddlc2(*functionargs):
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_idxa = net_from_list(idxa, DT_INT, "ALGLIB: parameter 'idxa' of 'xalglib.minlpaddlc2' must be int vector")
    _net_vala = net_from_list(vala, DT_REAL, "ALGLIB: parameter 'vala' of 'xalglib.minlpaddlc2' must be real vector")
    _net_nnz = nnz
    _net_al = al
    _net_au = au
    try:
        ...
        # call function
        _net_alglib.minlpaddlc2(_net_state, _net_idxa, _net_vala, _net_nnz, _net_al, _net_au)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpoptimize(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minlpoptimize(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minlpresults(*functionargs):
    ...
    try:
        ...
        # call function
        _net_x, _net_rep = _net_alglib.minlpresults(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    x = list_from_net(_net_x, DT_REAL)
    rep = minlpreport_from_net(_net_rep)

    # return
    return (x, rep)

def minlpresultsbuf(*functionargs):
    # unpack inputs
    state, x, rep = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.minlpresultsbuf' must be real vector")
    _net_rep = _net_alglib.minlpreport()
    net_from_minlpreport(_net_rep, rep)
    try:

        # call function
        _net_x, _net_rep = _net_alglib.minlpresultsbuf(_net_state, _net_x, _net_rep)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minnlcsetcond(*functionargs):
    ...
    try:
        ...
        # call function
        _net_alglib.minnlcsetcond(_net_state, _net_epsx, _net_maxits)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minnlcsetalgoslp(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minnlcsetalgoslp(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minnlcsetalgosqp(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minnlcsetalgosqp(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minnlcoptguardgradient(*functionargs):
    # unpack inputs
    state, teststep = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minnlcoptguardgradient(_net_state, _net_teststep)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minnlcoptguardsmoothness(*functionargs):
    ...
    if len(functionargs)==2:
        ...
        # short-form call
        state,  = functionargs
        level = check_equality_and_get([1],"Error while calling 'minnlcoptguardsmoothness': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'minnlcoptguardsmoothness': function must have 2 or 1 parameters")
    ...
    try:
        ...
        # call function
        _net_alglib.minnlcoptguardsmoothness(_net_state, _net_level)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minnlcoptguardresults(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_rep = _net_alglib.minnlcoptguardresults(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minnlcoptguardnonc1test0results(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_strrep, _net_lngrep = _net_alglib.minnlcoptguardnonc1test0results(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minnlcoptguardnonc1test1results(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_strrep, _net_lngrep = _net_alglib.minnlcoptguardnonc1test1results(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minnlcrequesttermination(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minnlcrequesttermination(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minbcoptguardgradient(*functionargs):
    # unpack inputs
    state, teststep = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.minbcoptguardgradient(_net_state, _net_teststep)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minbcoptguardsmoothness(*functionargs):
    ...
    if len(functionargs)==2:
        ...
        # short-form call
        state,  = functionargs
        level = check_equality_and_get([1],"Error while calling 'minbcoptguardsmoothness': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'minbcoptguardsmoothness': function must have 2 or 1 parameters")
    ...
    try:
        ...
        # call function
        _net_alglib.minbcoptguardsmoothness(_net_state, _net_level)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minbcoptguardresults(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_rep = _net_alglib.minbcoptguardresults(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minbcoptguardnonc1test0results(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_strrep, _net_lngrep = _net_alglib.minbcoptguardnonc1test0results(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def minbcoptguardnonc1test1results(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_strrep, _net_lngrep = _net_alglib.minbcoptguardnonc1test1results(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
class lptestproblem(object):
    def __init__(self,ptr):
        self.ptr = ptr
def lptestproblemserialize(obj):
    try:
        return _net_alglib.lptestproblemserialize(obj.ptr)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

def lptestproblemunserialize(s_in):
    try:
        return lptestproblem(_net_alglib.lptestproblemunserialize(s_in))
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
def lptestproblemcreate(*functionargs):
    # unpack inputs
    n, hasknowntarget, targetf = functionargs
    friendly_form = False

    # convert to .NET types
    _net_n = n
    _net_hasknowntarget = hasknowntarget
    _net_targetf = targetf
    try:

        # call function
        _net_p = _net_alglib.lptestproblemcreate(_net_n, _net_hasknowntarget, _net_targetf)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    p = lptestproblem(_net_p)

    # return
    return p

def lptestproblemsetscale(*functionargs):
    # unpack inputs
    p, s = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_p = p.ptr
    _net_s = net_from_list(s, DT_REAL, "ALGLIB: parameter 's' of 'xalglib.lptestproblemsetscale' must be real vector")
    try:

        # call function
        _net_alglib.lptestproblemsetscale(_net_p, _net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def lptestproblemsetcost(*functionargs):
    # unpack inputs
    p, c = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_p = p.ptr
    _net_c = net_from_list(c, DT_REAL, "ALGLIB: parameter 'c' of 'xalglib.lptestproblemsetcost' must be real vector")
    try:

        # call function
        _net_alglib.lptestproblemsetcost(_net_p, _net_c)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def lptestproblemsetbc(*functionargs):
    # unpack inputs
    p, bndl, bndu = functionargs
    friendly_form = False

    # convert to .NET types
    _net_p = p.ptr
    _net_bndl = net_from_list(bndl, DT_REAL, "ALGLIB: parameter 'bndl' of 'xalglib.lptestproblemsetbc' must be real vector")
    _net_bndu = net_from_list(bndu, DT_REAL, "ALGLIB: parameter 'bndu' of 'xalglib.lptestproblemsetbc' must be real vector")
    try:

        # call function
        _net_alglib.lptestproblemsetbc(_net_p, _net_bndl, _net_bndu)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def lptestproblemsetlc2(*functionargs):
    # unpack inputs
    p, a, al, au, m = functionargs
    friendly_form = False

    # convert to .NET types
    _net_p = p.ptr
    _net_a = a.ptr
    _net_al = net_from_list(al, DT_REAL, "ALGLIB: parameter 'al' of 'xalglib.lptestproblemsetlc2' must be real vector")
    _net_au = net_from_list(au, DT_REAL, "ALGLIB: parameter 'au' of 'xalglib.lptestproblemsetlc2' must be real vector")
    _net_m = m
    try:

        # call function
        _net_alglib.lptestproblemsetlc2(_net_p, _net_a, _net_al, _net_au, _net_m)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def xdbgminlpcreatefromtestproblem(*functionargs):
    # unpack inputs
    p,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_state = _net_alglib.xdbgminlpcreatefromtestproblem(_net_p)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def kdtreequeryrnnu(*functionargs):
    ...
    if len(functionargs)==4:
        ...
        # short-form call
        kdt, x, r = functionargs
        selfmatch = check_equality_and_get([True],"Error while calling 'kdtreequeryrnnu': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'kdtreequeryrnnu': function must have 4 or 3 parameters")

    # convert to .NET types
    _net_kdt = kdt.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.kdtreequeryrnnu' must be real vector")
    _net_r = r
    _net_selfmatch = selfmatch
    try:

        # call function
        _net_result = _net_alglib.kdtreequeryrnnu(_net_kdt, _net_x, _net_r, _net_selfmatch)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def kdtreetsqueryrnnu(*functionargs):
    ...
    if len(functionargs)==5:
        ...
        # short-form call
        kdt, buf, x, r = functionargs
        selfmatch = check_equality_and_get([True],"Error while calling 'kdtreetsqueryrnnu': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'kdtreetsqueryrnnu': function must have 5 or 4 parameters")

    # convert to .NET types
    _net_kdt = kdt.ptr
    _net_buf = buf.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.kdtreetsqueryrnnu' must be real vector")
    _net_r = r
    _net_selfmatch = selfmatch
    try:

        # call function
        _net_result = _net_alglib.kdtreetsqueryrnnu(_net_kdt, _net_buf, _net_x, _net_r, _net_selfmatch)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def normalpdf(*functionargs):
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.normalpdf(_net_x)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def normalcdf(*functionargs):
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.normalcdf(_net_x)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def invnormalcdf(*functionargs):
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.invnormalcdf(_net_y0)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def bivariatenormalpdf(*functionargs):
    # unpack inputs
    x, y, rho = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.bivariatenormalpdf(_net_x, _net_y, _net_rho)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def bivariatenormalcdf(*functionargs):
    # unpack inputs
    x, y, rho = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.bivariatenormalcdf(_net_x, _net_y, _net_rho)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwserialize(obj):
    try:
        return _net_alglib.idwserialize(obj.ptr)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

def idwunserialize(s_in):
    try:
        return idwmodel(_net_alglib.idwunserialize(s_in))
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
def idwcreatecalcbuffer(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_buf = _net_alglib.idwcreatecalcbuffer(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    buf = idwcalcbuffer(_net_buf)

    # return
    return buf

def idwbuildercreate(*functionargs):
    # unpack inputs
    nx, ny = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_state = _net_alglib.idwbuildercreate(_net_nx, _net_ny)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    state = idwbuilder(_net_state)

    # return
    return state

def idwbuildersetnlayers(*functionargs):
    # unpack inputs
    state, nlayers = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.idwbuildersetnlayers(_net_state, _net_nlayers)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwbuildersetpoints(*functionargs):
    ...
    if len(functionargs)==3:
        ...
        n = check_equality_and_get([safe_rows("'idwbuildersetpoints': incorrect parameters",xy)],"Error while calling 'idwbuildersetpoints': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'idwbuildersetpoints': function must have 3 or 2 parameters")

    # convert to .NET types
    _net_state = state.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.idwbuildersetpoints' must be real matrix")
    _net_n = n
    try:

        # call function
        _net_alglib.idwbuildersetpoints(_net_state, _net_xy, _net_n)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwbuildersetalgomstab(*functionargs):
    # unpack inputs
    state, srad = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.idwbuildersetalgomstab(_net_state, _net_srad)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwbuildersetalgotextbookshepard(*functionargs):
    # unpack inputs
    state, p = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.idwbuildersetalgotextbookshepard(_net_state, _net_p)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwbuildersetalgotextbookmodshepard(*functionargs):
    # unpack inputs
    state, r = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.idwbuildersetalgotextbookmodshepard(_net_state, _net_r)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwbuildersetuserterm(*functionargs):
    # unpack inputs
    state, v = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.idwbuildersetuserterm(_net_state, _net_v)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwbuildersetconstterm(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.idwbuildersetconstterm(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwbuildersetzeroterm(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.idwbuildersetzeroterm(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwcalc1(*functionargs):
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.idwcalc1(_net_s, _net_x0)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwcalc2(*functionargs):
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.idwcalc2(_net_s, _net_x0, _net_x1)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwcalc3(*functionargs):
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.idwcalc3(_net_s, _net_x0, _net_x1, _net_x2)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwcalc(*functionargs):
    ...
    try:
        ...
        # call function
        _net_y = _net_alglib.idwcalc(_net_s, _net_x)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwcalcbuf(*functionargs):
    ...
    # convert to .NET types
    _net_s = s.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.idwcalcbuf' must be real vector")
    _net_y = net_from_list(y, DT_REAL, "ALGLIB: parameter 'y' of 'xalglib.idwcalcbuf' must be real vector")
    try:

        # call function
        _net_y = _net_alglib.idwcalcbuf(_net_s, _net_x, _net_y)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwtscalcbuf(*functionargs):
    ...
    _net_s = s.ptr
    _net_buf = buf.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.idwtscalcbuf' must be real vector")
    _net_y = net_from_list(y, DT_REAL, "ALGLIB: parameter 'y' of 'xalglib.idwtscalcbuf' must be real vector")
    try:

        # call function
        _net_y = _net_alglib.idwtscalcbuf(_net_s, _net_buf, _net_x, _net_y)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def idwfit(*functionargs):
    ...
    try:
        ...
        # call function
        _net_model, _net_rep = _net_alglib.idwfit(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    model = idwmodel(_net_model)
    rep = idwreport_from_net(_net_rep)
...
def spline1dfit(*functionargs):
    ...
    if len(functionargs)==5:
        ...
        n = check_equality_and_get([safe_len("'spline1dfit': incorrect parameters",x), safe_len("'spline1dfit': incorrect parameters",y)],"Error while calling 'spline1dfit': looks like one of arguments has wrong size")
        friendly_form = True
    else:
        raise RuntimeError("Error while calling 'spline1dfit': function must have 5 or 4 parameters")

    # convert to .NET types
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.spline1dfit' must be real vector")
    _net_y = net_from_list(y, DT_REAL, "ALGLIB: parameter 'y' of 'xalglib.spline1dfit' must be real vector")
    _net_n = n
    _net_m = m
    ...
    try:
        ...
        # call function
        _net_s, _net_rep = _net_alglib.spline1dfit(_net_x, _net_y, _net_n, _net_m, _net_lambdans)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def fitspherels(*functionargs):
    # unpack inputs
    xy, npoints, nx = functionargs
    friendly_form = False

    # convert to .NET types
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.fitspherels' must be real matrix")
    _net_npoints = npoints
    _net_nx = nx
    try:

        # call function
        _net_cx, _net_r = _net_alglib.fitspherels(_net_xy, _net_npoints, _net_nx)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def fitspheremc(*functionargs):
    # unpack inputs
    xy, npoints, nx = functionargs
    friendly_form = False

    # convert to .NET types
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.fitspheremc' must be real matrix")
    _net_npoints = npoints
    _net_nx = nx
    try:

        # call function
        _net_cx, _net_rhi = _net_alglib.fitspheremc(_net_xy, _net_npoints, _net_nx)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def fitspheremi(*functionargs):
    # unpack inputs
    xy, npoints, nx = functionargs
    friendly_form = False

    # convert to .NET types
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.fitspheremi' must be real matrix")
    _net_npoints = npoints
    _net_nx = nx
    try:

        # call function
        _net_cx, _net_rlo = _net_alglib.fitspheremi(_net_xy, _net_npoints, _net_nx)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def fitspheremz(*functionargs):
    # unpack inputs
    xy, npoints, nx = functionargs
    friendly_form = False

    # convert to .NET types
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.fitspheremz' must be real matrix")
    _net_npoints = npoints
    _net_nx = nx
    try:

        # call function
        _net_cx, _net_rlo, _net_rhi = _net_alglib.fitspheremz(_net_xy, _net_npoints, _net_nx)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def fitspherex(*functionargs):
    # unpack inputs
    xy, npoints, nx, problemtype, epsx, aulits, penalty = functionargs
    friendly_form = False

    # convert to .NET types
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.fitspherex' must be real matrix")
    _net_npoints = npoints
    _net_nx = nx
    _net_problemtype = problemtype
    _net_epsx = epsx
    ...
    try:
        ...
        # call function
        _net_cx, _net_rlo, _net_rhi = _net_alglib.fitspherex(_net_xy, _net_npoints, _net_nx, _net_problemtype, _net_epsx, _net_aulits, _net_penalty)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def net_from_spline2dfitreport(x,v):
    x.rmserror = float(v.rmserror)
    x.avgerror = float(v.avgerror)
    x.maxerror = float(v.maxerror)
    x.r2 = float(v.r2)
...
def spline2dfitreport_from_net(x):
    r = spline2dfitreport()
    r.rmserror = x.rmserror
    r.avgerror = x.avgerror
    r.maxerror = x.maxerror
...
def spline2dserialize(obj):
    try:
        return _net_alglib.spline2dserialize(obj.ptr)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

def spline2dunserialize(s_in):
    try:
        return spline2dinterpolant(_net_alglib.spline2dunserialize(s_in))
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dcalcvi(*functionargs):
    # unpack inputs
    c, x, y, i = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.spline2dcalcvi(_net_c, _net_x, _net_y, _net_i)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2ddiffvi(*functionargs):
    # unpack inputs
    c, x, y, i = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_f, _net_fx, _net_fy, _net_fxy = _net_alglib.spline2ddiffvi(_net_c, _net_x, _net_y, _net_i)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildercreate(*functionargs):
    # unpack inputs
    d,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_state = _net_alglib.spline2dbuildercreate(_net_d)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    state = spline2dbuilder(_net_state)

    # return
    return state

def spline2dbuildersetuserterm(*functionargs):
    # unpack inputs
    state, v = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.spline2dbuildersetuserterm(_net_state, _net_v)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildersetlinterm(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.spline2dbuildersetlinterm(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildersetconstterm(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.spline2dbuildersetconstterm(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildersetzeroterm(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.spline2dbuildersetzeroterm(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildersetpoints(*functionargs):
    # unpack inputs
    state, xy, n = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_state = state.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.spline2dbuildersetpoints' must be real matrix")
    _net_n = n
    try:

        # call function
        _net_alglib.spline2dbuildersetpoints(_net_state, _net_xy, _net_n)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildersetareaauto(*functionargs):
    # unpack inputs
    state,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.spline2dbuildersetareaauto(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildersetarea(*functionargs):
    # unpack inputs
    state, xa, xb, ya, yb = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.spline2dbuildersetarea(_net_state, _net_xa, _net_xb, _net_ya, _net_yb)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildersetgrid(*functionargs):
    # unpack inputs
    state, kx, ky = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.spline2dbuildersetgrid(_net_state, _net_kx, _net_ky)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildersetalgofastddm(*functionargs):
    # unpack inputs
    state, nlayers, lambdav = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.spline2dbuildersetalgofastddm(_net_state, _net_nlayers, _net_lambdav)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildersetalgoblocklls(*functionargs):
    # unpack inputs
    state, lambdans = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.spline2dbuildersetalgoblocklls(_net_state, _net_lambdans)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dbuildersetalgonaivells(*functionargs):
    # unpack inputs
    state, lambdans = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.spline2dbuildersetalgonaivells(_net_state, _net_lambdans)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def spline2dfit(*functionargs):
    ...
    try:
        ...
        # call function
        _net_s, _net_rep = _net_alglib.spline2dfit(_net_state)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    s = spline2dinterpolant(_net_s)
    rep = spline2dfitreport_from_net(_net_rep)
...
def rbfpeekprogress(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.rbfpeekprogress(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def rbfrequesttermination(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.rbfrequesttermination(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def pcatruncatedsubspacesparse(*functionargs):
    # unpack inputs
    x, npoints, nvars, nneeded, eps, maxits = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_s2, _net_v = _net_alglib.pcatruncatedsubspacesparse(_net_x, _net_npoints, _net_nvars, _net_nneeded, _net_eps, _net_maxits)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def net_from_dfreport(x,v):
    ...
    x.topvars = net_from_list(v.topvars, DT_INT)
    x.varimportances = net_from_list(v.varimportances, DT_REAL)
    return
...
def dfreport_from_net(x):
    ...
    r.topvars = list_from_net(x.topvars, DT_INT)
    r.varimportances = list_from_net(x.varimportances, DT_REAL)
    return r
...
def dfunserialize(s_in):
    try:
        ...
        raise RuntimeError(e.msg)
def dfcreatebuffer(*functionargs):
    # unpack inputs
    model,  = functionargs
    friendly_form = False

    # convert to .NET types
    _net_model = model.ptr
    try:

        # call function
        _net_buf = _net_alglib.dfcreatebuffer(_net_model)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    buf = decisionforestbuffer(_net_buf)

    # return
    return buf

def dfbuildercreate(*functionargs):
    # unpack inputs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_s = _net_alglib.dfbuildercreate()
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    s = decisionforestbuilder(_net_s)

    # return
    return s

def dfbuildersetdataset(*functionargs):
    # unpack inputs
    s, xy, npoints, nvars, nclasses = functionargs
    friendly_form = False

    # convert to .NET types
    _net_s = s.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.dfbuildersetdataset' must be real matrix")
    _net_npoints = npoints
    _net_nvars = nvars
    ...
    try:
        ...
        # call function
        _net_alglib.dfbuildersetdataset(_net_s, _net_xy, _net_npoints, _net_nvars, _net_nclasses)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetrndvars(*functionargs):
    # unpack inputs
    s, rndvars = functionargs
    friendly_form = False

    # convert to .NET types
    _net_s = s.ptr
    _net_rndvars = rndvars
    try:

        # call function
        _net_alglib.dfbuildersetrndvars(_net_s, _net_rndvars)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetrndvarsratio(*functionargs):
    # unpack inputs
    s, f = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.dfbuildersetrndvarsratio(_net_s, _net_f)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetrndvarsauto(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.dfbuildersetrndvarsauto(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetsubsampleratio(*functionargs):
    # unpack inputs
    s, f = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.dfbuildersetsubsampleratio(_net_s, _net_f)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetseed(*functionargs):
    # unpack inputs
    s, seedval = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.dfbuildersetseed(_net_s, _net_seedval)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetrdfalgo(*functionargs):
    # unpack inputs
    s, algotype = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.dfbuildersetrdfalgo(_net_s, _net_algotype)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetrdfsplitstrength(*functionargs):
    # unpack inputs
    s, splitstrength = functionargs
    friendly_form = False

    # convert to .NET types
    _net_s = s.ptr
    _net_splitstrength = splitstrength
    try:

        # call function
        _net_alglib.dfbuildersetrdfsplitstrength(_net_s, _net_splitstrength)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetimportancetrngini(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.dfbuildersetimportancetrngini(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetimportanceoobgini(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.dfbuildersetimportanceoobgini(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetimportancepermutation(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.dfbuildersetimportancepermutation(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildersetimportancenone(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.dfbuildersetimportancenone(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuildergetprogress(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.dfbuildergetprogress(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuilderpeekprogress(*functionargs):
    # unpack inputs
    s,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.dfbuilderpeekprogress(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbuilderbuildrandomforest(*functionargs):
    # unpack inputs
    s, ntrees = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_df, _net_rep = _net_alglib.dfbuilderbuildrandomforest(_net_s, _net_ntrees)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfbinarycompression(*functionargs):
    # unpack inputs
    df,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_result = _net_alglib.dfbinarycompression(_net_df)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfprocess0(*functionargs):
    # unpack inputs
    model, x = functionargs
    friendly_form = False

    # convert to .NET types
    _net_model = model.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.dfprocess0' must be real vector")
    try:

        # call function
        _net_result = _net_alglib.dfprocess0(_net_model, _net_x)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dfclassify(*functionargs):
    ...
    # convert to .NET types
    _net_model = model.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.dfclassify' must be real vector")
    try:

        # call function
        _net_result = _net_alglib.dfclassify(_net_model, _net_x)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def dftsprocess(*functionargs):
    # unpack inputs
    df, buf, x, y = functionargs
    friendly_form = False

    # convert to .NET types
    _net_df = df.ptr
    _net_buf = buf.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.dftsprocess' must be real vector")
    _net_y = net_from_list(y, DT_REAL, "ALGLIB: parameter 'y' of 'xalglib.dftsprocess' must be real vector")
    try:

        # call function
        _net_y = _net_alglib.dftsprocess(_net_df, _net_buf, _net_x, _net_y)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnserialize(obj):
    try:
        return _net_alglib.knnserialize(obj.ptr)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

def knnunserialize(s_in):
    try:
        return knnmodel(_net_alglib.knnunserialize(s_in))
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
def knncreatebuffer(*functionargs):
    # unpack inputs
    model,  = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_buf = _net_alglib.knncreatebuffer(_net_model)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    buf = knnbuffer(_net_buf)

    # return
    return buf

def knnbuildercreate(*functionargs):
    # unpack inputs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_s = _net_alglib.knnbuildercreate()
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnbuildersetdatasetreg(*functionargs):
    # unpack inputs
    s, xy, npoints, nvars, nout = functionargs
    friendly_form = False

    # convert to .NET types
    _net_s = s.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.knnbuildersetdatasetreg' must be real matrix")
    _net_npoints = npoints
    _net_nvars = nvars
    _net_nout = nout
    try:
        ...
        # call function
        _net_alglib.knnbuildersetdatasetreg(_net_s, _net_xy, _net_npoints, _net_nvars, _net_nout)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnbuildersetdatasetcls(*functionargs):
    # unpack inputs
    s, xy, npoints, nvars, nclasses = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_s = s.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.knnbuildersetdatasetcls' must be real matrix")
    _net_npoints = npoints
    _net_nvars = nvars
    _net_nclasses = nclasses
    try:
        ...
        # call function
        _net_alglib.knnbuildersetdatasetcls(_net_s, _net_xy, _net_npoints, _net_nvars, _net_nclasses)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnbuildersetnorm(*functionargs):
    # unpack inputs
    s, nrmtype = functionargs
    friendly_form = False

    # convert to .NET types
    _net_s = s.ptr
    _net_nrmtype = nrmtype
    try:

        # call function
        _net_alglib.knnbuildersetnorm(_net_s, _net_nrmtype)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnbuilderbuildknnmodel(*functionargs):
    # unpack inputs
    s, k, eps = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_model, _net_rep = _net_alglib.knnbuilderbuildknnmodel(_net_s, _net_k, _net_eps)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)

    # convert from .NET types
    model = knnmodel(_net_model)
    rep = knnreport_from_net(_net_rep)

    # return
    return (model, rep)

def knnrewritekeps(*functionargs):
    # unpack inputs
    model, k, eps = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.knnrewritekeps(_net_model, _net_k, _net_eps)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnprocess(*functionargs):
    # unpack inputs
    model, x, y = functionargs
    friendly_form = False

    # convert to .NET types
    _net_model = model.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.knnprocess' must be real vector")
    _net_y = net_from_list(y, DT_REAL, "ALGLIB: parameter 'y' of 'xalglib.knnprocess' must be real vector")
    try:

        # call function
        _net_y = _net_alglib.knnprocess(_net_model, _net_x, _net_y)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnprocess0(*functionargs):
    ...
    # convert to .NET types
    _net_model = model.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.knnprocess0' must be real vector")
    try:

        # call function
        _net_result = _net_alglib.knnprocess0(_net_model, _net_x)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnclassify(*functionargs):
    ...
    # convert to .NET types
    _net_model = model.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.knnclassify' must be real vector")
    try:

        # call function
        _net_result = _net_alglib.knnclassify(_net_model, _net_x)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnprocessi(*functionargs):
    ...
    # convert to .NET types
    _net_model = model.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.knnprocessi' must be real vector")
    try:

        # call function
        _net_y = _net_alglib.knnprocessi(_net_model, _net_x)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knntsprocess(*functionargs):
    # unpack inputs
    model, buf, x, y = functionargs
    friendly_form = False

    # convert to .NET types
    _net_model = model.ptr
    _net_buf = buf.ptr
    _net_x = net_from_list(x, DT_REAL, "ALGLIB: parameter 'x' of 'xalglib.knntsprocess' must be real vector")
    _net_y = net_from_list(y, DT_REAL, "ALGLIB: parameter 'y' of 'xalglib.knntsprocess' must be real vector")
    try:

        # call function
        _net_y = _net_alglib.knntsprocess(_net_model, _net_buf, _net_x, _net_y)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnrelclserror(*functionargs):
    # unpack inputs
    model, xy, npoints = functionargs
    friendly_form = False

    # convert to .NET types
    _net_model = model.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.knnrelclserror' must be real matrix")
    _net_npoints = npoints
    try:

        # call function
        _net_result = _net_alglib.knnrelclserror(_net_model, _net_xy, _net_npoints)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnavgce(*functionargs):
    ...
    # convert to .NET types
    _net_model = model.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.knnavgce' must be real matrix")
    _net_npoints = npoints
    try:

        # call function
        _net_result = _net_alglib.knnavgce(_net_model, _net_xy, _net_npoints)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnrmserror(*functionargs):
    ...
    # convert to .NET types
    _net_model = model.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.knnrmserror' must be real matrix")
    _net_npoints = npoints
    try:

        # call function
        _net_result = _net_alglib.knnrmserror(_net_model, _net_xy, _net_npoints)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnavgerror(*functionargs):
    ...
    # convert to .NET types
    _net_model = model.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.knnavgerror' must be real matrix")
    _net_npoints = npoints
    try:

        # call function
        _net_result = _net_alglib.knnavgerror(_net_model, _net_xy, _net_npoints)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnavgrelerror(*functionargs):
    # unpack inputs
    model, xy, npoints = functionargs
    friendly_form = False
    ...
    # convert to .NET types
    _net_model = model.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.knnavgrelerror' must be real matrix")
    _net_npoints = npoints
    try:

        # call function
        _net_result = _net_alglib.knnavgrelerror(_net_model, _net_xy, _net_npoints)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def knnallerrors(*functionargs):
    ...
    # convert to .NET types
    _net_model = model.ptr
    _net_xy = net_from_listlist(xy, DT_REAL, "ALGLIB: parameter 'xy' of 'xalglib.knnallerrors' must be real matrix")
    _net_npoints = npoints
    try:

        # call function
        _net_rep = _net_alglib.knnallerrors(_net_model, _net_xy, _net_npoints)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
