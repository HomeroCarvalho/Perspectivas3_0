...
End Sub
    ...
    Public Sub hqrndnormalv(ByVal state As hqrndstate, ByVal n As Integer, ByRef x() As Double)
        Try
    ...
    Public Sub hqrndnormalm(ByVal state As hqrndstate, ByVal m As Integer, ByVal n As Integer, ByRef x(,) As Double)
        Try
    ...
    Public Sub sparsesymmpermtblbuf(ByVal a As sparsematrix, ByVal isupper As Boolean, ByVal p() As Integer, ByVal b As sparsematrix)
        Try
    ...
    Public Function sparsecholesky(ByVal a As sparsematrix, ByVal isupper As Boolean) As Boolean
        Try
    ...
    Public Function sparsecholeskyp(ByVal a As sparsematrix, ByVal isupper As Boolean, ByRef p() As Integer) As Boolean
        Try
    ...
    Public Function sparsecholeskyfactorize(ByVal analysis As sparsedecompositionanalysis, ByVal needupper As Boolean, ByRef a As sparsematrix, ByRef d() As Double, ByRef p() As Integer) As Boolean
        Try
            a = New sparsematrix()
    ...
    Public Sub sparsecholeskyreload(ByVal analysis As sparsedecompositionanalysis, ByVal a As sparsematrix, ByVal isupper As Boolean)
        Try
    ...
    Public Sub sparsesolversetalgogmres(ByVal state As sparsesolverstate, ByVal k As Integer)
        Try
    ...
    Public Sub sparsesolversetstartingpoint(ByVal state As sparsesolverstate, ByVal x() As Double)
        Try
    ...
    Public Sub sparsesolversetcond(ByVal state As sparsesolverstate, ByVal epsf As Double, ByVal maxits As Integer)
        Try
    ...
    Public Sub sparsesolversolvesymmetric(ByVal state As sparsesolverstate, ByVal a As sparsematrix, ByVal isupper As Boolean, ByVal b() As Double)
        Try
    ...
    Public Sub sparsesolversolve(ByVal state As sparsesolverstate, ByVal a As sparsematrix, ByVal b() As Double)
        Try
    ...
    Public Sub sparsesolverresults(ByVal state As sparsesolverstate, ByRef x() As Double, ByRef rep As sparsesolverreport)
        Try
            rep = New sparsesolverreport()
    ...
    Public Sub sparsesolversetxrep(ByVal state As sparsesolverstate, ByVal needxrep As Boolean)
        Try
    ...
    Public Sub sparsesolveroocstart(ByVal state As sparsesolverstate, ByVal b() As Double)
        Try
    ...
    Public Function sparsesolverooccontinue(ByVal state As sparsesolverstate) As Boolean
        Try
    ...
    Public Sub sparsesolveroocgetrequestinfo(ByVal state As sparsesolverstate, ByRef requesttype As Integer)
        Try
    ...
    Public Sub sparsesolveroocgetrequestdata(ByVal state As sparsesolverstate, ByRef x() As Double)
        Try
    ...
    Public Sub sparsesolveroocgetrequestdata1(ByVal state As sparsesolverstate, ByRef v As Double)
        Try
    ...
    Public Sub sparsesolveroocsendresult(ByVal state As sparsesolverstate, ByVal ax() As Double)
        Try
    ...
    Public Sub sparsesolveroocstop(ByVal state As sparsesolverstate, ByRef x() As Double, ByRef rep As sparsesolverreport)
        Try
            rep = New sparsesolverreport()
    ...
    Public Sub sparsesolverrequesttermination(ByVal state As sparsesolverstate)
        Try
    ...
    Public Sub minqpaddlc2sparsefromdense(ByVal state As minqpstate, ByVal da() As Double, ByVal al As Double, ByVal au As Double)
        Try
    ...
    Public Sub minlpsetalgodss(ByVal state As minlpstate, ByVal eps As Double)
        Try
    ...
    Public Sub minlpsetalgoipm(ByVal state As minlpstate, ByVal eps As Double)
        Try
    ...
    Public Sub minlpsetalgoipm(ByVal state As minlpstate)
        Try
    ...
    Public Sub lptestproblemsetscale(ByVal p As lptestproblem, ByVal s() As Double)
        Try
    ...
    Public Sub lptestproblemsetcost(ByVal p As lptestproblem, ByVal c() As Double)
        Try
    ...
    Public Sub lptestproblemsetbc(ByVal p As lptestproblem, ByVal bndl() As Double, ByVal bndu() As Double)
        Try
    ...
    Public Sub lptestproblemsetlc2(ByVal p As lptestproblem, ByVal a As sparsematrix, ByVal al() As Double, ByVal au() As Double, ByVal m As Integer)
        Try
